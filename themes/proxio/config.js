...
const CONFIG = {
  ...
  PROXIO_HERO_TITLE_1: '我们分享各自所拍摄的景象', // 英雄区文字
  PROXIO_HERO_TITLE_2: '通过景象，让我们连接在一起', // 英雄区文字
  // 英雄区两个按钮，如果TEXT留空则隐藏按钮
  PROXIO_HERO_BUTTON_1_TEXT: '上传image', // 英雄区按钮
  PROXIO_HERO_BUTTON_1_URL:
    'https://docs.tangly1024.com/article/vercel-deploy-notion-next', // 英雄区按钮
  PROXIO_HERO_BUTTON_2_TEXT: '在ig上关注', // 英雄区按钮
 ...
 // hero区背景，默认是获取Notion背景，如需另外配置图片可以填写在这里
  ...
  PROXIO_FEATURE_TITLE: 'why this website',
  PROXIO_FEATURE_TEXT_1: 'we can share and illuminate your dream',
  ...
  PROXIO_CAREERS: [
    {
      ...
      bio: '2021-2024',
      text: 'As a high school student, I worked on a range of residential and commercial projects, balancing form and function. I collaborated with clients and contractors to transform concepts into reality, ensuring each design was both aesthetically pleasing and structurally sound.'
    },
    {
      title: 'Uni Student',
      bio: '2025-now',
  ...
  PROXIO_TESTIMONIALS_TITLE: 'Comments from our users',
  ...
  PROXIO_ABOUT_TITLE: 'About the creator',
  PROXIO_ABOUT_TEXT_1: 'Now, trying to be a programmer',
  PROXIO_ABOUT_TEXT_2:
    '',
